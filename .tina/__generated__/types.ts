...
export type Query = {
  ...
  getBlogpostsDocument: BlogpostsDocument
  getBlogpostsList: BlogpostsConnection
}
...
export type QueryGetBlogpostsDocumentArgs = {
  relativePath?: InputMaybe<Scalars['String']>
}

export type QueryGetBlogpostsListArgs = {
  before?: InputMaybe<Scalars['String']>
  after?: InputMaybe<Scalars['String']>
  first?: InputMaybe<Scalars['Float']>
  last?: InputMaybe<Scalars['Float']>
...
export type DocumentNode = PostsDocument | BlogpostsDocument
...
export type BlogpostsDocument = Node &
  Document & {
    __typename?: 'BlogpostsDocument'
    id: Scalars['ID']
    sys: SystemInfo
    data: Blogposts
    form: Scalars['JSON']
...
export type Mutation = {
  ...
  updateBlogpostsDocument: BlogpostsDocument
  createBlogpostsDocument: BlogpostsDocument
}
...
export type MutationUpdateBlogpostsDocumentArgs = {
  relativePath: Scalars['String']
  params: BlogpostsMutation
}

export type MutationCreateBlogpostsDocumentArgs = {
  relativePath: Scalars['String']
  params: BlogpostsMutation
}
...
export type PostsMutation = {
  ...
  lastmod?: InputMaybe<Scalars['String']>
...
export type BlogpostsPartsFragment = {
  __typename?: 'Blogposts'
  title?: string | null
  body?: string | null
}
...
export type GetBlogpostsDocumentQueryVariables = Exact<{
  relativePath: Scalars['String']
}>

export type GetBlogpostsDocumentQuery = {
  __typename?: 'Query'
  getBlogpostsDocument: {
    ...
    data: { __typename?: 'Blogposts'; title?: string | null; body?: string | null }
  }
}

export type GetBlogpostsListQueryVariables = Exact<{ [key: string]: never }>
...
export const GetPostsListDocument = gql`
  ...
  ${PostsPartsFragmentDoc}
`
export const GetBlogpostsDocumentDocument = gql`
  query getBlogpostsDocument($relativePath: String!) {
    getBlogpostsDocument(relativePath: $relativePath) {
      sys {
        filename
        basename
        breadcrumbs
...
`
export const GetBlogpostsListDocument = gql`
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    ...
    getPostsList(
      ...
      return requester<
        { data: GetPostsListQuery; variables: GetPostsListQueryVariables; query: string },
        GetPostsListQueryVariables
      >(GetPostsListDocument, variables, options)
    },
    getBlogpostsDocument(
      variables: GetBlogpostsDocumentQueryVariables,
      options?: C
    ): Promise<{
      data: GetBlogpostsDocumentQuery
      variables: GetBlogpostsDocumentQueryVariables
      query: string
    }> {
      return requester<
        ...
        GetBlogpostsDocumentQueryVariables
      >(GetBlogpostsDocumentDocument, variables, options)
    },
    getBlogpostsList(
      variables?: GetBlogpostsListQueryVariables,
      options?: C
    ): Promise<{
      data: GetBlogpostsListQuery
      variables: GetBlogpostsListQueryVariables
      query: string
    }> {
      return requester<
        { data: GetBlogpostsListQuery; variables: GetBlogpostsListQueryVariables; query: string },
        GetBlogpostsListQueryVariables
      >(GetBlogpostsListDocument, variables, options)
    },
  }
}
