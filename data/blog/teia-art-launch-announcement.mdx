...
You can read some of the details on the new marketplace contract [here](https://hencommunity.quest/blog/introducing-henc-smart-contracts), and you can view the contract itself [here](https://github.com/teia-community/objkt-swap/blob/3.0.0/smart-py/marketplace.py). An independent audit of the contract was completed by inference.ag, and you can find more details about this in the blog post.
...
* Teia Community Twitter (old: [@hen_community](https://twitter.com/hen_community), new: tbe)    
