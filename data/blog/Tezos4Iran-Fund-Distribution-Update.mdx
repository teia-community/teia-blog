...
authors: ['merchantcoppola', 'ruralidyll', 'stu', 'malicioussheep']
---

_News about the donations for Tezos4Iran_



# Update on Fund distribution for Tezos4Iran

The [#Tezos4Iran Fundraiser event (click for mopre details)](https://github.com/teia-community/teia-docs/wiki/Tezos-for-Iran) has been a great success so far, raising over 5500 (16.11.22) Tezos in donations thanks to the Tezos Art community. It is a symbol of solidarity with the brave Iranians protesting for their human rights in the streets right now.
