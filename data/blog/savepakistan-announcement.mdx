---
title: '#savepakiustan - Tezos Flood Relief Fundraiser'
date: 2022-09-22T10:00:00Z
lastmod: '2022-09-22'
tags: ['crossplatform', 'charity', 'fundraiser', 'announcement', 'interview']
draft: false
summary: '#savepakistan - info and interview on the charity initiative for pakistan'
bibliography: references-data.bib
authors: ['merchantcoppola', 'ruralidyll']
---

_#savepakistan - info and interview on the charity initiative for Pakistan_
...
Starting now, use this address to **set up split contracts/swaps on any tezos marketplace** (i.e. Teia, Versum, FxHash, ObjktCom) or **donate tezos directly** to the address.

The hastag for the initiative is **#savepakistan** - Let's use this event hashtag for minting event pieces and for twitter posts that relate to the event to concentrate attention on the fundraiser.

**Raising awareness** about the Pakistani floods is key for this initiative, so please help spreading the word! I.e. by following and sharing posts from [Savepakistans Twitter account](https://twitter.com/Savepakistanorg)

* Teia will set up a **dedicated feed** on the main page for pieces that have a split of at least 50% of the revenue towards the donation address
* ObjktCom will curate and highlight fundraiser pieces on their front page
* Teztok will set up a marketplace agnostic event page
* ... and there is much more collaborations in the making to highlight art that contributes to the initiative so stay tuned!
...
For this reason the contract will remain open and rolling to donations. We are in contact with more marketplaces and will try to keep this fundraiser initiative growing with more marketplaces and events social media actors joining to highlight it. 
...
**Nida Sheikh:** Tayaba.org spreads its message and raises awareness regarding water accessibility and social issues through the following socials and website:
