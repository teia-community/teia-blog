...
---
name: Ted McBlogger
avatar: /static/images/tedmcblogger.png
occupation: French Fry Chef
...
For example, the following frontmatter will display the authors given by `data/authors/default.md` and `data/authors/merchantcoppola.md`
