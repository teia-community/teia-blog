---
title: 'Teia Newsletter #13 - December 9th 2022'
date: 2022-10-31T00:00:00Z
lastmod: '2022-10-31'
tags: ['communication', 'update', 'newsletter']
draft: false
summary: 'Paperwork, New socials, turbo upgrades and fundraiser reports'
bibliography: references-data.bib
authors: ['carolyn', 'merchantcoppola']
---

_Paperwork, New socials, turbo upgrades and fundraiser reports_


It has been some time since the last newsletter, but this does not mean there is nothing to update all you Teians about, quite the contrary. Our old friend, the table of contents is back to give you a quick overview of what the winter has in store for us. We will take a look at the state of Teia’s incorporation as a non-profit organisation, the huge upgrade Teia will get in early 2023, some past community event postmortems, the pledge to respect artists royalties, and new social media spaces for our community.
...
TezTok has received a Tezos Foundation grant for developing plug-ins and switching from hictdex to TezTok as Teia’s Indexer. TezTok is a GraphQL indexer for the whole Tezos NFT ecosystem that normalizes token data from the different Tezos marketplaces/tokens.
...
- A new main feed with the option to show prices and edition.
- Masonry feed.
...
In short: We will soon see a lot of visual changes to the Marketplace, stay tuned! If you are interested in seeing the work-in-progress or want to help bug-testing, take a look at 

### New Feature: Thumbnail Previews are Here!

You may have already noticed that your [teia.art](http://teia.art) URL auto-populate a preview image for each OBJKT when sharing a OBJKT link on social media like Twitter, Discord, Mastodon, etc.
...
![Preview URL for an NFT of a generative art glitch bird by __orderandchaos ]([Newsletter%20Teia%20Community%20Update%20#13%20e65f5db0eb1f44f3a4552d3d7ef07d26/Screenshot_2022-12-02_at_17.56.56.png](https://user-images.githubusercontent.com/97635650/206791075-7cbe12ee-7aa3-43f1-8859-625e5fe50819.png))

### UI Update: Collabs Added to Creations Tab

![Teia UI screenshot of profile display tabs for Creations, Collection, and Collabs.]([Newsletter%20Teia%20Community%20Update%20#13%20e65f5db0eb1f44f3a4552d3d7ef07d26/Screenshot_2022-12-02_at_18.08.46.png](https://user-images.githubusercontent.com/97635650/206791177-4370ea85-53cc-4a99-a0ad-18bdcde02c08.png)

As announced in the last Newsletter, Pieces minted with only one core creator and only beneficiaries will now be displayed on the main “creations” tab of the sole core collaborator. This will increase visibility, especially for Fundraiser pieces that have been created by only one artist with a split contract. The Collab tab is still live and will remain only for your collaborations, and will remain visible be in both tabs.
...
For SavePakistan this far (Dec 4th) 15752 Tezos have been raised and handed off to SavePakistan/Tayaba. 10837 Artworks (counting every fx(hash) edition as a separate artwork)
...
Unfortunately, our off-ramping partners from [Crypto For Charity](https://www.cryptoforcharity.io/donate-crypto) informed us last month that the chosen Organisation “United 4 Iran” is no longer eligible to receive donations through their service. Therefore we had to find new beneficiaries for the funds and after a longer discussion and research we settled on splitting the donations between two organisations: After reviewing all the options we could find we decided to split the funds between the two following organsiations that are actively working on advocating for human rights in Iran, documenting and providing support for the protests:
...
Mastodons decentralized architecture of course fits the decentralised spirit of Teia very well so we set up our own Mastodon instance here:

[mastodon.teia.art](https://mastodon.teia.art/about) 

You can join the instance by simply signing up on that link. You will be able to follow and interact with people signed up on other instaces, so dont be afraid to join a smaller instance like ours. There are even ways to port profiles from one instance to another.
...
We have a nice little group of Teians on Mastodon that are testing the instance for a few weeks now. [Join us!](https://mastodon.teia.art/)
...
![[Link to Tweet about Tezos Platforms respecting creators royalities](https://twitter.com/TeiaCommunity/status/1590828908257349634?s=20&t=22_br6UwDpKvmbWy7w2ohQ)](https://user-images.githubusercontent.com/97635650/206791567-66d0ba13-5e77-4868-a939-2b014b2ddee4.png)
...
![[Youtube Link to the recorded twitter space aboout stillherenow](https://youtu.be/5Z_atLNWu3o)](https://user-images.githubusercontent.com/97635650/206792027-3ad9305e-2b75-4d00-b6d0-f89c58804e44.JPG)
