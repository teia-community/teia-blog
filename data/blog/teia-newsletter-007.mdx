...
The new indexer is based on DipDup 5.1.1 which no longer uses the hic*et_nunc* prefix for the tables. Developers using the GraphQL API need to adjust all GraphQL queries to remove the prefix for it to work.
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/xWphvaIWnYE"
