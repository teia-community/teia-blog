...
The pieces minted with the the event tag “Tezos4Iran” are being displayed on [Tezos4Iran.teia.rocks](https://tezos4iran.teia.rocks/). We will also soon have a dedicated feed for fundraiser pieces that shows OBJKTs that were either minted with the Iran donation address as beneficiary (of at least 50% of sales volume) or tagged with #Tezos4Iran. You can access this feed by clicking on “🇮🇷 iran” at the top of teia.art, as shown below. Since this event is more about showing solidarity and less about raising money, we will display all pieces minted with the hashtag, however the charity team will have the ability to remove pieces from the feed that clearly misuse the tag for simple self-promo and/or go against the code of conduct.
...
<img width="320" alt="screenshot of savepakistan event page" src="https://user-images.githubusercontent.com/97635650/198903675-9c5e1280-d8a2-4a31-8915-6922e0ce2eac.png">
