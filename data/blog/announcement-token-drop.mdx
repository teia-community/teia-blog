...
Teia was formed after the open-source marketplace ["hic et nunc" was discontinued in November 2021](https://github.com/crcdng/hen-timeline/blob/main/timeline.md) and has since been collectively built towards a community-run art platform that is governed by a DAO. This structure ensures that not a single person owns Teia and that the platform is collectively shaped by the DAO members.

The Teia DAO working group has outlined a governance structure, written the needed smart contracts, and officially registered Teia as a DAO LLC. The details are documented in teh [article "Governance on Teia" on our wiki](https://github.com/teia-community/teia-docs/wiki/Governance-on-Teia)
