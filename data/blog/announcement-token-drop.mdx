...
Claiming your TEIA tokens is free (except for the transaction fees, of course). Be aware that only [www.teia.art/claim](https://teia.art/claim) is the official token claim page. TEIA tokens will only be distributed through this specific URL and nowhere else.
