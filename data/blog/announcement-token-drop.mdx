---
title: 'TEIA token Distribution Announcement'
date: 2023-08-20T18:00:00Z
lastmod: '2023-08-20'
tags: ['communication', 'update', 'dao', 'discussion', 'hDAO']
draft: false
summary: 'How to claim your TEIA tokens'
bibliography: references-data.bib
authors: ['jagracar', 'merchantcoppola', 'turbulentdeterminism']
---

_How to claim your TEIA tokens_
...
The right side of the 'T' becomes a blank space for the rotational logos.“](https://github.com/teia-community/teia-blog/assets/97635650/f23684f0-a95b-452c-a324-637d472d1008)

> "The planified and geometric shadow of a 3D 'T', seen from its buttom"
*- Julio Glatt (Logo Designer)*

## Teia DAO Token Drop Details

The Token Drop event is scheduled to take place between August 20th and November 20th of 2023. During this time frame, the first batch of TEIA DAO tokens will be distributed to our community members via the token claim page [teia.art/claim](https://teia.art/claim).
Claiming your TEIA tokens is free (except for the transaction fees, of course). Be aware that only [www.teia.art/claim](https://teia.art/claimm) is the official token claim page. TEIA tokens will only be distributed through this specific URL and nowhere else.
...
As long as you meet one or more of these criteria, then your wallet should be eligible for TEIA tokens.
You can find a [spreadsheet with all eligible addresses and their amount of TEIA tokens here](https://docs.google.com/spreadsheets/d/11jFANEUsvNSc9vQGD7sc46n_BOp8v0tGOLY1LG0KENk/edit?usp=sharing). If your wallet does not show as eligible & you believe it should, then please come to our community discord for assistance or write us at info@teia.art.
...
The community has decided via an [on-chain vote that we should mint a total supply of 8 million tokens](https://vote.teia.art/vote/QmeJ9ATjn4ge9phDzvpmdZzRZdRoKJdyk4swPiVgaxAx6z). Unclaimed tokens will remain in the Teia treasury for future distribution events.
...
Owners of the tokens are going to be allowed to set up and vote on DAO proposals for Teia. The voting power is determined by the amount of 
