...
_the new community smartcontract and the new community multisig contract - an introduction_

# Introducing the new HENC platform smart contracts

(Editor's note, Jan26 2022: Due to the recent reactivation of "hicetnunc.art", we will change the name "v3" for our community marketplace contract in order to avoid possible confusion with hicetnuncs contract naming convention. pls note that hicetnunc.xyz was still discontinued when this blogpost and the articles linked in it where written)

Read the [HEN community marketplace smart contract](https://leonnicholls.medium.com/hic-et-nunc-v3-marketplace-smart-contract-ca1882b01b66) and [Hic Et Nunc multi-sig smart contract](https://leonnicholls.medium.com/hic-et-nunc-multi-sig-smart-contract-d1f63fe5d24) articles for a technical deep dive.
