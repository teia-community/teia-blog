...
(Editor's note, Jan26 2022: Due to the recent reactivation of "hicetnunc.xyz", we will change the name "v3" for our community marketplace contract in order to avoid possible confusion with hicetnuncs contract naming convention. pls note that hicetnunc.xyz was still discontinued when this blogpost and the articles linked in it where written)
