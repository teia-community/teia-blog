...
lastmod: '2022-01-12'
tags: ['communication', 'discussion', 'naming', 'vote', 'fact sheet', FAQ]
draft: false
...
authors: ['merchantcoppola', 'nagualito', 'malicioussheep', 'turbulent determinism', 'open document']
---
...
If you sync your wallet to our voting tool [vote.hencommunity.quest](https://vote.hencommunity.quest/), you can vote for your favourite name from a shortlist of 10 names (link to the vote below).

Note that only hicetnunc wallets created before the discontinuation (11/11/2021) are eligible to vote in order to prevent a dilution of the vote due to the creation of new accounts to gain voting power.  You can change your vote while the voting round is ongoing by voting again (you will still only have 1 vote).
...
**Voting round 1** will be up until [ENDDATE tba, vote has not started yet].  
[Click here to participate in voting round 1 (link tba, will be updated once the vote is set up)](https://vote.hencommunity.quest/proposals)
...
For this naming vote, every wallet will have the same voting weight. The cutoff date of the day of the discontinuation is a straight-forward filter to prevent participants from creating new (multiple) accounts to get more voting weight.
