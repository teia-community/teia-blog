...
650k Tokens are allocated as hDAO rewards, 350k Tokens are reserved for the Teia treasury (fututre distribution) adding up to 1 Million, the remaining supply is split up accoding to parameters layed out below in the Q&A section.
...
#### Is my activity on Objktcom/Versuum/Hicaf being counted for the activity rewards?
