...
Note that these tables are not final: The data might get updated for the actual token distribution, but these tables should give a very good preview of the token distribution.
