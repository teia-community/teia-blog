...
The storms have calmed a little and it has become chill and comfortable in our little community. That doesn't mean that nothing is happening, quite to the contrary: Our DAO is in its Beta phase, and ready to be used ([more info here](https://blog.teia.art/blog/dao-test-launch)) and stuff is happening. 
...
This new feature has been made possible by a community vote: It was suggested and voted on in [Teia Poll #15](https://teia.art/poll/15) and after the poll was sucessful, core team member [Ryan Tanaka](https://x.com/ryangtanaka) produced it and [kiks](https://github.com/kittypurrry) developed it with help from Teias volunteer dev team ([Link to the PR on Github)](https://github.com/teia-community/teia-ui/commit/af60898482f4b9041398dc1d68566d35e85bcbd9).
